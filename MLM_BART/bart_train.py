...
def main(args):
    if args.wandb_key:
        ...
        print("No WANDB API Key provided, skipping wandb login.")
    ...
    training_args = TrainingArguments(
        ...
        logging_dir="./logs",
        logging_steps=10,
        learning_rate=args.num_train_epochs,
        warmup_steps=500,
        weight_decay=0.01,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb_key", type=str, default=None, help="WANDB API Key for login")
    ...
    parser.add_argument("--max_length", type=int, default=256, help="Max input length during tokenization")
